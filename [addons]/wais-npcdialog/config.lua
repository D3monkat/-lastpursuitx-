...
Config.Peds = {
    [1] = {
        ...
        ["cam"] = vector4(-680.05, 5833.46, 17.33, 314.56), -- If the camera angle doesn't look right, give the heading a full negative value, e.g. -93.0 instead of 93.0. If this doesn't work, enter the heading value of the direction your pad is facing the npc!
