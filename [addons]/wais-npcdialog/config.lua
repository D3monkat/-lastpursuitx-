...
Config.Peds = {
    ...
    [2] = {
      ["model"] = "a_c_cat_01",
      ["coords"] = vector4(-584.19, -1060.57, 23.37, 271.22),
      ["cam"] = vector4(-583.38, -1060.39, 22.34, 90.81), -- If the camera angle doesn't look right, give the heading a full negative value, e.g. -93.0 instead of 93.0. If this doesn't work, enter the heading value of the direction your pad is facing the npc!
      ["markerCoord"] = vector3(-584.19, -1060.57, 23.37),
      ["interactive"] = {
          -- ["type"] = "target", -- or fivem keys https://docs.fivem.net/docs/game-references/controls/
          ["type"] = 38,-- https://docs.fivem.net/docs/game-references/controls/
