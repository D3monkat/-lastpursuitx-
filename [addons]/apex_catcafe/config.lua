...
Config.AdditionalTargets = {
    ...
    Prepareboard = {
        {
            Coords = vector3(-587.93, -1059.63, 22.34),
            Heading = 0.0,
            Size = {2.4, 0.6},
            Distance = 2.0,
            minZ = 22.34-0.3,
    ...
    Stove = {
        {
            Coords = vector3(-591.08, -1056.55, 22.34),
            Heading = 0.0,
            Size = {1.05, 0.65},
            Distance = 1.5,
            minZ = 22.34-0.2,
    ...
    Oven = {
        {
            Coords = vector3(-590.63, -1059.7, 22.34),
            Heading = 0.0,
            Size = {1.1, 0.2},
            Distance = 1.5,
            minZ = 22.34-1,
    ...
    Storage = {
        {
            Coords = vector3(-587.36, -1059.63, 22.34),
            Heading = 0.0,
            Size = {2.4, 0.6},
            Distance = 2.0,
            minZ = 22.34-0.3,
    ...
    Ingredients = {
        {
            Coords = vector3(-587.96, -1067.1, 22.34),
            Heading = 0.0,
            Size = {3.85, 0.6},
            Distance = 2.0,
            minZ = 22.34-1,
    ...
    Freezer = {
        {
            Coords = vector3(-590.62, -1068.03, 22.34),
            Heading = 0.0,
            Size = {2.0, 0.6},
            Distance = 2.0,
            minZ = 22.34-1,
    ...
    DrinkMachine = {
        {
            Coords = vector3(-586.91, -1061.91, 22.34),
            Heading = 0.0,
            Size = {0.75, 0.55},
            Distance = 1.5,
            minZ = 22.34-0.2,
    ...
    CashRegisters = {
        {
            Coords = vector3(-584.03, -1061.45, 22.34),
            Heading = 347.0,
            Size = {0.26, 0.44},
            Distance = 1.5,
            minZ = 22.34-0.1,
        ...
        {
            Coords = vector3(-584.07, -1058.74, 22.34),
            Heading = 10.0,
            Size = {0.26, 0.44},
            Distance = 1.5,
            minZ = 22.34-0.1,
    ...
    Trays = {
        {   Coords = vector3(-584.00, -1059.29, 22.34), Heading = 0.0,    Size = {0.7, 0.5}, Distance = 2.5, minZ = 22.34-0, maxZ = 22.34+0.3, },
        {   Coords = vector3(-584.06, -1062.04, 22.34), Heading = 0.0,    Size = {0.7, 0.5}, Distance = 2.5, minZ = 22.34-0, maxZ = 22.34+0.3, },
    },
}
