Config = {
	...
	Main = { -- Main variables
		...
		JobRoles = {"shoplux", "redline", "rexmech", "shopbluelinecustoms","shoptuner" }, -- These are the job roles who can use items if RequiresJob is enabled.
	...
	Emergency = {
		...
		Locations = {
			{ coords = vector4(457.42, -975.33, 25.71, 87.42), prop = true, }, -- MRPD UNDERGROUND PARKING
