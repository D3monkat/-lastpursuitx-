return {
	...
	PoliceArmoury = {
		...
		blip = {
			...
			{ name = 'nikon', price = 1, },
			{ name = 'sdcard', price = 1, },
			{ name = 'gsrtestkit', price = 1, },
			{ name = 'dnatestkit', price = 1, },
			{ name = 'drugtestkit', price = 1, },
			{ name = 'breathalyzer', price = 1, },
			{ name = 'fingerprintreader', price = 1, },
			{ name = 'accesstool', price = 1, },
			{ name = 'fingerprintkit', price = 1, },
			{ name = 'mikrosil', price = 1, },
			{ name = 'fingerprinttape', price = 1, },
			{ name = 'blox', price = 1, },
			{ name = 'microfibercloth', price = 1, },
