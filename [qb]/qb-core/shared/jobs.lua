...
QBShared.Jobs = {
	...
	police = {
		...
		grades = {
			...
			['2'] = { name = 'Officer 2', payment = 100 },
			['3'] = { name = 'Corporal', payment = 125 },
			['4'] = { name = 'Sergeant', isboss = true, payment = 150 },
			['5'] = { name = 'Detective', payment = 50 },
			['6'] = { name = 'Lead Detective', payment = 75 },
			['7'] = { name = 'Lieutenant', payment = 100 },
			['8'] = { name = 'Captain', payment = 125 },
			['9'] = { name = 'Commander', isboss = true, payment = 150 },
			['10'] = { name = 'Deputy Chief', payment = 50 },
			['11'] = { name = 'Assistant Chief', payment = 75 },
			['12'] = { name = 'Chief Of Police', payment = 150, isboss = true, bankAuth = true },
		},
	},
	...
	tuner = {
		...
		grades = {
			...
			['3'] = { name = 'Advanced', payment = 125 },
			['4'] = { name = 'Manager', isboss = true, payment = 150, bankAuth = true },
			['5'] = { name = 'Owner', isboss = true, payment = 175, bankAuth = true },
		},
	},
	blueline = {
