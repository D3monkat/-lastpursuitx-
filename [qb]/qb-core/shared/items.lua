...
weapon_colbaton 			 = {name = 'weapon_colbaton', 		 	  	label = 'PD Baton', 				weight = 1000, 		type = 'weapon', 	ammotype = nil,						image = 'weapon_colbaton.png', unique = true, 		useable = false,created = nil, 	description = 'A Pd Baton'},
    ...
    coke 		 	 	 	     = {name = "coke",           				label = "Cocaine", 					weight = 100,		type = "item", 		image = "coke.png", 				unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   expire = 90,  description = "Processed cocaine"},
    coca_leaf 		 	 	 	 = {name = "coca_leaf",           			label = "Cocaine leaves",	 		weight = 100,		type = "item", 		image = "coca_leaf.png", 			unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   expire = 90,  description = "Cocaine leaves that must be processed !"},
    ...
    poppyresin 		 	 	 	 = {name = "poppyresin",           			label = "Poppy resin",	 			weight = 100, 		type = "item", 		image = "poppyresin.png", 			unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   expire = 90,  description = "It sticks to your fingers when you handle it."},
    ...
    bakingsoda 		 	 	     = {name = "bakingsoda",           		    label = "Baking Soda",	 		    weight = 100, 		type = "item", 		image = "bakingsoda.png", 		    unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   expire = 90,  description = "Household Baking Soda!"},
