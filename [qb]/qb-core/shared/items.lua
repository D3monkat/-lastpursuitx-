...
QBShared.Items = {
    ...
    cigs                        = { name = 'cigs', label = 'cigs', weight = 0, type = 'item', image = 'cigs.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'You old fart...' },
    ...
    ceramic                       = { name = 'ceramic', label = 'ceramic', weight = 100, type = 'item', image = 'ceramic.png', unique = false, useable = false, shouldClose = false, combinable = nil, description = 'you can probably use this for something' },
    ...
    boombox          = { name = 'boombox', label = 'Boombox', weight = 100, type = 'item', image = 'boombox.png', unique = true, useable = true, shouldClose = true, combinable = nil, description = 'A Boombox' },
...
--Last Train
    --DRINKS
    lemonade 					= {name = "lemonade",  	    	 		label = "Lemonade",		 			weight = 100, 		type = "item", 		image = "lemonade.png", 		unique = false, 	useable = true, 	shouldClose = true,   	combinable = nil,   description = "", ['thirst'] = math.random(20, 30) },
    orangejuice 				= {name = "orangejuice",  	    	 	label = "Orange Juice",		 		weight = 100, 		type = "item", 		image = "orangejuice.png", 	unique = false, 	useable = true, 	shouldClose = true,   	combinable = nil,   description = "", ['thirst'] = math.random(20, 30) },
    blackcoffee 				= {name = "blackcoffee",  	    	 	label = "Black Coffee",		 		weight = 100, 		type = "item", 		image = "blackcoffee.png", 		unique = false, 	useable = true, 	shouldClose = true,   	combinable = nil,   description = "", ['thirst'] = math.random(20, 30) },
    applejuice 					= {name = "applejuice",  	    	 	label = "Apple Juice",		 		weight = 100, 		type = "item", 		image = "applejuice.png", 	unique = false, 	useable = true, 	shouldClose = true,   	combinable = nil,   description = "", ['thirst'] = math.random(20, 30) },
    hottea 					    = {name = "hottea",  	    	 	    label = "Hot Tea",		 		    weight = 100, 		type = "item", 		image = "hottea.png", 	unique = false, 	useable = true, 	shouldClose = true,   	combinable = nil,   description = "", ['thirst'] = math.random(20, 30) },
    sweettea 					= {name = "sweettea",  	    	 	    label = "Sweet Tea",		 		weight = 100, 		type = "item", 		image = "sweettea.png", 	unique = false, 	useable = true, 	shouldClose = true,   	combinable = nil,   description = "", ['thirst'] = math.random(20, 30) },
    chocolatemilkshake 			= {name = "chocolatemilkshake",  	    label = "Chocolate Milkshake",		weight = 100, 		type = "item", 		image = "chocoshake.png", 	unique = false, 	useable = true, 	shouldClose = true,   	combinable = nil,   description = "", ['thirst'] = math.random(20, 30) },
    strawberrymilkshake 		= {name = "strawberrymilkshake",  	    label = "Strawberry Milkshake",		weight = 100, 		type = "item", 		image = "strawshake.png", 	unique = false, 	useable = true, 	shouldClose = true,   	combinable = nil,   description = "", ['thirst'] = math.random(20, 30) },
    vanillamilkshake 			= {name = "vanillamilkshake",  	    	label = "Vanilla Milkshake",		weight = 100, 		type = "item", 		image = "nillashake.png", 	unique = false, 	useable = true, 	shouldClose = true,   	combinable = nil,   description = "", ['thirst'] = math.random(20, 30) },
    birthdaycakemilkshake 		= {name = "birthdaycakemilkshake",  	label = "Birthday cake Milkshake",	weight = 100, 		type = "item", 		image = "cakeshake.png", 	unique = false, 	useable = true, 	shouldClose = true,   	combinable = nil,   description = "", ['thirst'] = math.random(20, 30) },
    rootbeer 					= {name = "rootbeer",  	    	 	    label = "Rootbeer",		 		    weight = 100, 		type = "item", 		image = "rootbeer.png", 	unique = false, 	useable = true, 	shouldClose = true,   	combinable = nil,   description = "", ['thirst'] = math.random(20, 30) },
    ...
    eggomelette 				= {name = "3eggomelette",  	    	 	label = "3 Egg Omelette",		    weight = 100, 		type = "item", 		image = "omlette.png", 	unique = false, 	useable = true, 	shouldClose = true,   	combinable = nil,   description = "", ['hunger'] = math.random(20, 30) },
...
tacocrate 				     = {name = 'tacocrate', 			    		        label = 'Taco Crate', 			        weight = 1, 		type = 'item', 		image = 'tacocrate.png', 			unique = false, 	useable = true, 	shouldClose = true,	description = ''},
	...
	weapon_glock17 				 = {name = 'weapon_glock17', 			 	label = 'PD Glock 17', 				weight = 7000, 		type = 'weapon', 	ammotype = 'AMMO_PISTOL',			image = 'weapon_combat-pistol.png', 						unique = true, 		useable = false,created = nil,	description = 'PD GUN'},
	weapon_g17c 				 = {name = 'weapon_g17c', 			 	label = 'Glock 17c', 				weight = 7000, 		type = 'weapon', 	ammotype = 'AMMO_PISTOL',			image = 'weapon_combat-pistol.png', 						unique = true, 		useable = false,created = nil,	description = 'PD GUN'},
...
weapon_colbaton 			 = {name = 'weapon_colbaton', 		 	  	label = 'PD Baton', 				weight = 1000, 		type = 'weapon', 	ammotype = nil,						image = 'weapon_colbaton.png', unique = true, 		useable = false,created = nil, 	description = 'A Pd Baton'},
    ...
    skillreel 			     = {name = 'skill-reel', 					label = 'Skill Fishing Reel', 				weight = 1000, 		type = 'item', 		image = 'skill-reel.png', 			unique = true, 	useable = true, 	shouldClose = true,	   combinable = nil,   description = 'A skilled fishing reel.'},
    proreel 			     = {name = 'pro-reel', 					label = 'Pro Fishing Reel', 				weight = 1000, 		type = 'item', 		image = 'pro-reel.png', 			unique = true, 	useable = true, 	shouldClose = true,	   combinable = nil,   description = 'A professional fishing reel.'},
    ...
    fish 						= {name = "fish",  	     				label = "Fish",	 				weight = 1000, 		type = "item", 		image = "fish.png", 		unique = false, 	useable = false, 	shouldClose = false,   	combinable = nil,   description = "A Catfish" },
	...
	weed_og_kush_cbd_crop 	 	= {name = 'weed_og-kush_cbd_crop', 			label = 'CBD OG Kush Crop', 		weight = 1200, 		type = 'item', 		image = 'weed_og-kush_cbd_crop.png', 		unique = false, 	useable = false, 	shouldClose = false,   		combinable = nil,   description = 'A crop of CBD OG Kush'},
	weed_white_widow_cbd_crop 	= {name = 'weed_white-widow_cbd_crop',  	label = 'CBD White Widow Crop', 	weight = 1200, 		type = 'item', 		image = 'weed_white-widow_cbd_crop.png', 	unique = false, 	useable = false, 	shouldClose = false,   		combinable = nil,   description = 'A crop of CBD White Widow'},
	...
	weed_purple_haze_cbd_crop 	= {name = 'weed_purple-haze_cbd_crop', 	    label = 'CBD Purple-Haze Crop', 	weight = 1200, 		type = 'item', 		image = 'weed_purple-haze_cbd_crop.png', 	unique = false, 	useable = false, 	shouldClose = false,   		combinable = nil,   description = 'A crop of CBD Purple-Haze!'},
	...
	weed_og_kush_cbd 		 	= {name = 'weed_og-kush_cbd', 				label = 'CBD OGKush 2g', 			weight = 2, 		type = 'item', 		image = 'weed_og-kush_cbd.png', 			unique = false, 	useable = true, 	shouldClose = false,   		combinable = nil,   description = 'A 2g bag of CBD OG Kush!'},
	weed_white_widow_cbd 	 	= {name = 'weed_white-widow_cbd', 	    	label = 'CBD White Widow 2g', 		weight = 2, 		type = 'item', 		image = 'weed_white-widow_cbd.png', 		unique = false, 	useable = true, 	shouldClose = false,   		combinable = nil,   description = 'A 2g bag of CBD White Widow!'},
	...
	weed_purple_haze_cbd 		= {name = 'weed_purple-haze_cbd', 	    	label = 'CBD Purple-Haze 2g', 		weight = 2, 		type = 'item', 		image = 'weed_purple-haze_cbd.png', 		unique = false, 	useable = true, 	shouldClose = false,   		combinable = nil,   description = 'A 2g bag of CBD Purple-Haze!'},
	...
	weed_og_kush_cbd_joint 		= {name = 'weed_og-kush_cbd_joint', 		label = 'CBD OG Kush Joint', 		weight = 1, 		type = 'item', 		image = 'weed_og-kush_cbd_joint.png', 		unique = false, 	useable = true, 	shouldClose = false,   		combinable = nil,   description = 'Light up that og kush son!'},
	weed_white_widow_cbd_joint 	= {name = 'weed_white-widow_cbd_joint', 	label = 'CBD White Widow Joint', 	weight = 1, 		type = 'item', 		image = 'weed_white-widow_cbd_joint.png', 	unique = false, 	useable = true, 	shouldClose = false,   		combinable = nil,   description = 'Light up that white widow son!'},
	...
	weed_purple_haze_cbd_joint 	= {name = 'weed_purple-haze_cbd_joint', 	label = 'CBD Purple-Haze Joint', 	weight = 1, 		type = 'item', 		image = 'weed_purple-haze_cbd_joint.png', 		unique = false, 	useable = true, 	shouldClose = false,   		combinable = nil,   description = 'Light up that purple haze son!'},
	...
	gummy_og_kush_cbd 			= {name = 'gummy_og-kush_cbd', 			    label = 'CBD OG-Kush Gummy', 		weight = 4, 		type = 'item', 		image = 'gummy_og-kush_cbd.png', 			unique = false, 	useable = true, 	shouldClose = true,	   		combinable = nil,   description = 'A edible cbd og kush gummy bear!'},
	gummy_white_widow_cbd 		= {name = 'gummy_white-widow_cbd', 			label = 'CBD White-Widow Gummy', 	weight = 4, 		type = 'item', 		image = 'gummy_white-widow_cbd.png', 			unique = false, 	useable = true, 	shouldClose = true,	   		combinable = nil,   description = 'A edible cbd white widow gummy bear!'},
	...
	gummy_purple_haze_cbd 		= {name = 'gummy_purple-haze_cbd', 			label = 'CBD Purple-Haze Gummy', 	weight = 4, 		type = 'item', 		image = 'gummy_purple-haze_cbd.png', 		unique = false, 	useable = true, 	shouldClose = true,	   		combinable = nil,   description = 'A edible cbd purple haze gummy bear!'},
    ...
    shark_boi       = {name = "shark_boi", 			label = "Shark Boi", 		weight = 0, 	    type = "item", 		image = "shark_boi.png", 				unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    monkey_punk 	= {name = "monkey_punk", 		label = "Monkey Punk", 		weight = 0, 	    type = "item", 		image = "monkey_punk.png", 				unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    monky 			= {name = "monky", 			  	label = "Monkey", 			weight = 0, 	    type = "item", 		image = "monky.png", 				    unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    fox 			= {name = "fox", 			  	label = "Fox", 				weight = 0, 	    type = "item", 		image = "fox.png", 				        unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    questing_mouse 	= {name = "questing_mouse", 	label = "Quest Mouse", 		weight = 0, 	    type = "item", 		image = "questing_mouse.png", 		    unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    armored_cat 	= {name = "armored_cat", 		label = "Armored Cat", 		weight = 0, 	    type = "item", 		image = "armored_cat.png", 				unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    hollow_knight 	= {name = "hollow_knight", 		label = "Hollow Knight", 	weight = 0, 	    type = "item", 		image = "hollow_knight.png", 			unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    knight_cat 		= {name = "knight_cat", 		label = "Knight Cat", 		weight = 0, 	    type = "item", 		image = "knight_cat.png", 				unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    dino 		    = {name = "dino", 		        label = "Dino", 		    weight = 0, 	    type = "item", 		image = "dino.png", 				    unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    dino_student    = {name = "dino_student", 		label = "Dino", 		    weight = 0, 	    type = "item", 		image = "dino_student.png", 		    unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    pig_angel       = {name = "pig_angel", 		    label = "Angel Pig", 		weight = 0, 	    type = "item", 		image = "pig_angel.png", 				unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    mickey_mouse    = {name = "mickey_mouse", 		label = "Mickey Mouse",     weight = 0, 	    type = "item", 		image = "mickey_mouse.png", 		    unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    blossom         = {name = "blossom", 		    label = "Blossom",          weight = 0, 	    type = "item", 		image = "blossom.png", 		            unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    buttercup       = {name = "buttercup", 		    label = "Buttercup",        weight = 0, 	    type = "item", 		image = "buttercup.png", 		        unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    bubbles         = {name = "bubbles", 		    label = "Bubbles",          weight = 0, 	    type = "item", 		image = "bubbles.png", 		            unique = false, 	useable = true, 	shouldClose = true,    combinable = nil,   description = "Looks expensive to me o.o"},
    
    videorecord 				 = {name = 'videorecord', 			    	label = 'Video Record', 			weight = 200, 	type = 'item', 		image = 'key1.png', 				unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = '0x0x'},
    key1 				 		 = {name = 'key1', 			    			label = 'Casino Key 1', 			weight = 200, 	type = 'item', 		image = 'key1.png', 				unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = '0x0x'},
    key2 				 		 = {name = 'key2', 			    			label = 'Casino Key 2', 			weight = 200, 	type = 'item', 		image = 'key2.png', 				unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = '0x0x'},
    drill 				 		 = {name = 'drill', 			    		label = 'Drill', 					weight = 200, 	type = 'item', 		image = 'drill.png', 				unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = '0x0x'},
    bag 						 = {name = "bag", 							label = "Bag", 						weight = 5, 	type = "item", 		image = "bag.png", 					unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = "Bag"},
    cutter 					 	 = {name = "cutter", 						label = "cutter", 					weight = 5, 	type = "item", 		image = "cutter.png", 				unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = "Cutter"},
    c4_bomb 			 		 = {name = 'c4_bomb', 		    			label = 'C4', 						weight = 100, 	type = 'weapon', 	ammotype = nil,						image = 'weapon_stickybomb.png', 	unique = true, 		useable = false, 	description = '0x0x'},
    thermite_bomb 			 	 = {name = 'thermite_bomb', 		    	label = 'Thermite Bomb', 			weight = 100, 	type = 'weapon', 	ammotype = nil,						image = 'weapon_stickybomb.png', 	unique = true, 		useable = false, 	description = '0x0x'},
    thermite 			 	 	 = {name = 'thermite', 		    			label = 'Thermite Bomb', 			weight = 100, 	type = 'weapon', 	ammotype = nil,						image = 'weapon_stickybomb.png', 	unique = true, 		useable = false, 	description = '0x0x'},
    bolt_cutter 			 	 = {name = 'bolt_cutter', 		    		label = 'Bolt Cutter', 				weight = 100, 	type = 'weapon', 	ammotype = nil,						image = 'weapon_stickybomb.png', 	unique = true, 		useable = false, 	description = '0x0x'},
    laptop 				 		 = {name = 'laptop', 			  	  		label = 'Laptop', 					weight = 400, 	type = 'item', 		image = 'laptop.png', 				unique = false, 	useable = false, 	shouldClose = true,	   combinable = nil,   description = 'Expensive laptop'},
    hack_usb 				 	 = {name = 'hack_usb', 			  	  		label = 'Hack USB', 				weight = 100, 	type = 'item', 		image = 'usb_device.png', 			unique = false, 	useable = false, 	shouldClose = true,	   combinable = nil,   description = 'Handy software to shut down some systems'},
    ...
    vanpogo 				 	 = {name = 'vanpogo', 			  	  		label = 'vanPogo', 					weight = 100, 	type = 'item', 		image = 'vanPogo.png', 				unique = false, 	useable = false, 	shouldClose = true,	   combinable = nil,   description = 'Stolen Artwork'},
    diamond 				 	 = {name = 'diamond', 			  	  		label = 'Diamond', 					weight = 100, 	type = 'item', 		image = 'vanDiamond.png', 			unique = false, 	useable = false, 	shouldClose = true,	   combinable = nil,   description = 'Stolen Artwork'},
    panther 				 	 = {name = 'panther', 			  	  		label = 'Panther', 					weight = 100, 	type = 'item', 		image = 'vanPanther.png', 			unique = false, 	useable = false, 	shouldClose = true,	   combinable = nil,   description = 'Stolen Artwork'},
    bottle 				 	 	 = {name = 'bottle', 			  	  		label = 'Bottle', 					weight = 100, 	type = 'item', 		image = 'vanBottle.png', 			unique = false, 	useable = false, 	shouldClose = true,	   combinable = nil,   description = 'Stolen Artwork'},
    pogo 				 	 	 = {name = 'pogo', 			  	  			label = 'Pogo', 					weight = 100, 	type = 'item', 		image = 'vanPogo.png', 				unique = false, 	useable = false, 	shouldClose = true,	   combinable = nil,   description = 'Stolen Artwork'},
    artskull 				 	 = {name = 'artskull', 			  			label = 'Art Skull', 				weight = 100, 	type = 'item', 		image = 'vanNecklace.png', 			unique = false, 	useable = false, 	shouldClose = true,	   combinable = nil,   description = 'Stolen Artwork'},
    artegg 				 		 = {name = 'artegg', 			  			label = 'Art Egg', 					weight = 100, 	type = 'item', 		image = 'vanNecklace.png', 			unique = false, 	useable = false, 	shouldClose = true,	   combinable = nil,   description = 'Stolen Artwork'},
    artgun 				 		 = {name = 'artgun', 			  			label = 'Art Gun', 					weight = 100, 	type = 'item', 		image = 'vanNecklace.png', 			unique = false, 	useable = false, 	shouldClose = true,	   combinable = nil,   description = 'Stolen Artwork'},
    artlamp 				 	 = {name = 'artlamp', 			  			label = 'Art Lamp', 				weight = 100, 	type = 'item', 		image = 'vanNecklace.png', 			unique = false, 	useable = false, 	shouldClose = true,	   combinable = nil,   description = 'Stolen Artwork'},
    arthorse 				 	 = {name = 'arthorse', 			  			label = 'Art Horse', 				weight = 100, 	type = 'item', 		image = 'vanNecklace.png', 			unique = false, 	useable = false, 	shouldClose = true,	   combinable = nil,   description = 'Stolen Artwork'},
    big_drill 				 	 = {name = 'big_drill', 			    	label = 'big_drill', 				weight = 200, 	type = 'item', 		image = 'big_drill.png', 			unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = '0x0x'},
    gasmask 				 	 = {name = 'gasmask', 			    		label = 'gasmask', 					weight = 200, 	type = 'item', 		image = 'gasmask.png', 				unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = '0x0x'},
    blowtorch 				 	 = {name = 'blowtorch', 			    	label = 'blowtorch', 			    weight = 200, 	type = 'item', 		image = 'blowtorch.png', 			unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = '0x0x'},
    weed_pooch 				 	 = {name = 'weed_pooch', 			    	label = 'Weed Pooch', 			    weight = 200, 	type = 'item', 		image = 'blowtorch.png', 			unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = '0x0x'},
    coke_pooch 				 	 = {name = 'coke_pooch', 			    	label = 'Coke Pooch', 			    weight = 200, 	type = 'item', 		image = 'blowtorch.png', 			unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = '0x0x'},
    gold 				 	     = {name = 'gold', 			    	        label = 'Gold Bar', 			    weight = 200, 	type = 'item', 		image = 'blowtorch.png', 			unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = '0x0x'},
    diamond 				 	 = {name = 'diamond', 			    	    label = 'Diamond Box', 			    weight = 200, 	type = 'item', 		image = 'blowtorch.png', 			unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = '0x0x'},
    goldwatch 				 	 = {name = 'goldwatch', 			    	label = 'Gold Watch', 			    weight = 200, 	type = 'item', 		image = 'blowtorch.png', 			unique = false, 	useable = false, 	shouldClose = false,   combinable = nil,   description = '0x0x'},
