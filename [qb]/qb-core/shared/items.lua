...
eggomelette 				= {name = "eggomelette",  	    	 	label = "Egg Omelette",		    weight = 100, 		type = "item", 		image = "omlette.png", 	unique = false, 	useable = true, 	shouldClose = true,   	combinable = nil,   description = "", ['hunger'] = math.random(20, 30) },
