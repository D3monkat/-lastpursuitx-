...
QBShared.Items = {
    ...
    boombox          = { name = 'boombox', label = 'Boombox', weight = 100, type = 'item', image = 'boombox.png', unique = true, useable = true, shouldClose = false, combinable = nil, description = 'A Boombox' },
