...
Config.ExperienceRequirement = { 
	[1] = { 
		Requirement = 0, --Experience required to start work
        MinExpDrop = 1, --The minimum experience drop cannot be greater than MaxExpDrop
        MaxExpDrop = 3, --The maximum experience drop
        Payout = 1700, --Pay for work
	},
    [2] = { 
		Requirement = 200, --Experience required to start work
        MinExpDrop = 2, --The minimum experience drop cannot be greater than MaxExpDrop
        MaxExpDrop = 5, --The maximum experience drop
        Payout = 3100, --Pay for work
	},
    [3] = { 
		Requirement = 430, --Experience required to start work
        MinExpDrop = 3, --The minimum experience drop cannot be greater than MaxExpDrop
        MaxExpDrop = 6, --The maximum experience drop
        Payout = 6700, --Pay for work
	},
}

Config.builder = {
	['BossSpawn'] = { 
		Pos = {x = -247.37, y = -962.36, z = 31.22, h = 261.95}, --Place of commencement of work
		Type  = 'csb_reporter', --model ped
	}
}
...
Config.Places2lvl = {
    [1] = {
        Pos = {x = 141.09, y = -379.73, z = 43.26, h = 45.53}, --The place where the order is accepted
        VehiclePos = {x = 136.45, y = -377.96, z = 43.07, h = 339.15}, --The place where the vehicle appears
		Type  = 's_m_y_construct_02', --model ped
        Vehicle = 'burrito', --model vehicle
        PlaceLoad = {x = 2677.49, y = 3513.01, z = 52.71, h = 140.84}, --The place where the pick-up pallet appears
        PlaceUnLoad = {x = 101.17, y = -394.56, z = 41.26, h = 61.10}, --Place of unloading the vehicle
    },
    [2] = {
        Pos = {x = -97.26, y = -1013.91, z = 27.28, h = 163.54}, 
        VehiclePos = {x = -104.33, y = -1016.32, z = 27.09, h = 252.83},
		Type  = 's_m_y_construct_02',
        Vehicle = 'burrito', 
        PlaceLoad = {x = -2035.28, y = -274.38, z = 23.39, h = 71.29}, 
        PlaceUnLoad = {x = -98.60, y = -1049.86, z = 27.42, h = 259.07}, 
    },
    [3] = {
        Pos = {x = -471.29, y = -865.11, z = 23.96, h = 169.62}, 
        VehiclePos = {x = -468.19, y = -873.91, z = 23.59, h = 91.39},
		Type  = 's_m_y_construct_02',
        Vehicle = 'burrito', 
        PlaceLoad = {x = 874.45, y = -955.78, z = 26.28, h = 321.33}, 
        PlaceUnLoad = {x = -502.94, y = -942.17, z = 23.79, h = 157.11}, 
    },
}
