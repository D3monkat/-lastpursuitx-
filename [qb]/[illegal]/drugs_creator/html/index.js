...
async function addPocketCrafting(itemName, pocketCraftingData, isNew = false) {
	...
	const div = $(`
		<div class="pocket-crafting mb-4" data-item-to-use="${itemName}">
			<h2 class="text-center title">${getLocalizedText("menu:you_have_to_use")} -> ${itemLabel} <span class="fs-5 fw-lighter fst-italic">(${itemName})</span></h2>
	...
	let itemEffectDiv = $(`
		<div class="drug-effect mb-4">
			...
			<div class="effects mt-3">
				...
				<div class="row row row-cols-3 mb-4">
