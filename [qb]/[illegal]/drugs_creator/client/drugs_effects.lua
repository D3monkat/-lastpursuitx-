...
allEffects.yellow_visual = function(duration)
    local effectName = "visual_color"
...
allEffects.blurred_visual = function(duration)
    local effectName = "visual_color"
...
allEffects.red_visual = function(duration)
    local effectName = "visual_color"
...
allEffects.foggy_visual = function(duration)
    local effectName = "visual_color"
...
allEffects.blue_visual = function(duration)
    local effectName = "visual_color"
...
allEffects.remove_old_effects = function()
    for effectName, effectTime in pairs(activeEffects) do
        if(effectTime) then
