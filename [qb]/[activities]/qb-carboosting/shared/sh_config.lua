...
Shared.Debug = true -- Debug console prints

--- Settings related to core
...
Shared.BoostInterval = 30 -- Amount of minutes between new boost contracts
...
Shared.ReduceAmount = 1 -- When failing a hack, the current amount of hacks is reduced by this value

--- Crushing
Shared.Crushing = vector3(2396.68, 3111.36, 48.13)
Shared.CrushingRadius = 5.0

--- Ranks
Shared.Ranks = {
    [1] = { label = 'D',    minRep = 0,     maxRep = 120 },
    [2] = { label = 'C',    minRep = 121,   maxRep = 250 },
    [3] = { label = 'B',    minRep = 251,   maxRep = 450 },
    [4] = { label = 'A',    minRep = 451,   maxRep = 800 },
    [5] = { label = 'S',    minRep = 801,   maxRep = 1500 },
    [6] = { label = 'S+',   minRep = 1501,  maxRep = 9999 },
}
...
Shared.Peds = { -- You can add extra ped models in here
    `csb_g`,
    `csb_grove_str_dlr`,
    `csb_ortega`,
    `csb_ramp_mex`,
